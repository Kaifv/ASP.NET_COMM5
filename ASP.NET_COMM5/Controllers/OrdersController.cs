...
namespace ASP.NET_COMM5.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            ViewData["CustomerFK"] = new SelectList(_context.Customers, "customerId", "customerId");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("orderID,dateOrderPlaced,dateOrderPaid,paymentMethod,CustomerFK")] Order order)
        {
            if (id != order.orderID)
            {
                return NotFound();
